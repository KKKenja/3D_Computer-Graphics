static public class Matrix4{
  ...
  void makeRotX(float a) {
    // TODO HW2
    // You need to implement the rotation of x-axis matrix here. (Pitch)
  ...
  void makeRotY(float a) {
    // TODO HW2
    // You need to implement the rotation of y-axis matrix here. (Yaw)
    makeIdentity();
    m[0] = cos(a);
    m[2] = sin(a);
    m[8] = -sin(a);
  ...
  void makeRotZ(float a) {
     // TODO HW2
     // You need to implement the rotation of z-axis matrix here. (Roll)
    makeIdentity();
    m[0] = cos(a);
    m[1] = -sin(a);
    m[4] = sin(a);
