...
public class Inspector {
    ...
    public void run() {
        ...
        if (gameObject != null) {
            ...
            // Update camera view matrix if the gameObject is a Camera
                ...
                materialButton.run(() -> {
                    switch (gameObject.me) {
                        ...
                        case GM:
                            ...
                            break;
                        case PM:
                            // Store reference for async callback
                            pendingTextureObject = gameObject;
                            materialButton.name = "Selecting Texture...";
                            // Open file selection dialog
                            selectInput("Select texture image", "textureSelected", dataFile("Textures"));
                            break;
                        case TM:
