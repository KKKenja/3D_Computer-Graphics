public class GameObject {
    ...
    GameObject(String fname) {
        ...
        // Set default scale to 0.1 for large models
        ...
        for (int i=0; i<mesh.triangles.size(); i++) {
            ...
            for (int y = int(minY); y < maxY; y++) {
                for (int x = int(minX); x < maxX; x++) {
                    ...
                    // Correct depth interpolation with perspective correction
                    float z = abg[0] * s_Position[0].z + abg[1] * s_Position[1].z + abg[2] * s_Position[2].z;
